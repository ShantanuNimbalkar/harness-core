...
class PmsSdkInitValidator {
  ...
  static void validatePlanCreators(
    ...
    final Map<String, Set<String>> supportedVariables =
        supportedTypesV(pipelineServiceInfoProvider.getVariableCreators());
   ...
   */
  static Map<String, Set<String>> supportedTypesP(List<PartialPlanCreator<?>> planCreators) {
  ...
  private static Map<String, Set<String>> supportedTypesV(List<VariableCreator> variableCreators) {
    Map<String, Set<String>> supportedTypes = new HashMap<>();
  ...
  private static Map<String, Set<String>> supportedTypesF(List<FilterJsonCreator> filterCreators) {
    Map<String, Set<String>> supportedTypes = new HashMap<>();
