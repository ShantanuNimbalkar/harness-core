...
@Slf4j
public class DelegateServiceDriverRule implements MethodRule, InjectorRuleMixin, MongoRuleMixin {
  ClosingFactory closingFactory;

  public DelegateServiceDriverRule(ClosingFactory closingFactory) {
