...
@OwnedBy(GITOPS)
@Slf4j
public class GitOpsTestRule implements InjectorRuleMixin, MethodRule, MongoRuleMixin {
  protected Injector injector;
  ClosingFactory closingFactory;

  public GitOpsTestRule(ClosingFactory closingFactory) {
  ...
  public List<Module> modules(List<Annotation> annotations) throws Exception {
    ...
    modules.add(GitopsModule.getInstance());
    return modules;
  }
