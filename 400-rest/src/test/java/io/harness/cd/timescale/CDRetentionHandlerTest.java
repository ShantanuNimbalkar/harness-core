...
public class CDRetentionHandlerTest {
  ...
  @Mock private CDRetentionPeriod cdRetentionPeriod;
  @InjectMocks CDRetentionHandler retentionHandler;

  @Test
  @Owner(developers = VIKYATH_HAREKAL)
  @Category(UnitTests.class)
  public void testConfigureRetentionPolicy() {
    when(cdRetentionPeriod.getRetentionPeriod()).thenReturn(SEVEN_MONTHS);
