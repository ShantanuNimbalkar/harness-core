...
public class K8sReleaseHelperTest extends CategoryTest {
  ...
  public void testExtractLabelValueFromRelease() {
    ...
    assertThat(releaseHelper.getReleaseLabelValue(release, RELEASE_NUMBER_LABEL_KEY)).isEqualTo("1");
    assertThat(releaseHelper.getReleaseLabelValue(release, "SomeUnknownKey")).isEmpty();
  }
  ...
  public void testK8sArgConstruction() {
    assertThat(releaseHelper.createSetBasedArg("k1", Set.of("v1"))).isEqualTo("k1 in (v1)");
    assertThat(releaseHelper.createListBasedArg("k1", "v1")).isEqualTo("k1=v1");
    assertThat(releaseHelper.createCommaSeparatedKeyValueList(Map.of("k1", "v1"))).isEqualTo("k1=v1");
    assertThat(releaseHelper.generateName("releaseName", 1)).isEqualTo("release.releaseName.1");

    Map<String, String> labels = releaseHelper.generateLabels("name", 1, "status");
    ...
    Map<String, String> labelsMap = releaseHelper.createLabelsMap("release");
