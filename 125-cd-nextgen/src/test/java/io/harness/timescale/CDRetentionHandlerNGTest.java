...
public class CDRetentionHandlerNGTest extends CategoryTest {
  ...
  @Mock private CDRetentionPeriodNG cdRetentionPeriodNG;
  @InjectMocks CDRetentionHandlerNG retentionHandler;

  @Test
  @Owner(developers = VIKYATH_HAREKAL)
  @Category(UnitTests.class)
  public void testConfigureRetentionPolicy() {
    when(cdRetentionPeriodNG.getRetentionPeriod()).thenReturn(SEVEN_MONTHS);
