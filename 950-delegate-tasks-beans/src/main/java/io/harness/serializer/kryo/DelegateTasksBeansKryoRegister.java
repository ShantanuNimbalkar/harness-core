...
import io.harness.delegate.beans.ci.HostedVmInfraInfo;
import io.harness.delegate.beans.ci.K8InfraInfo;
...
public class DelegateTasksBeansKryoRegister implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(CIExecuteStepTaskParams.class, 29000);
    kryo.register(CIExecuteStepTaskParams.Type.class, 29001);
    kryo.register(CICleanupTaskParams.class, 29002);
    kryo.register(CICleanupTaskParams.Type.class, 29003);
    kryo.register(InfraInfo.Type.class, 29004);
    kryo.register(DockerInfraInfo.class, 29005);
    kryo.register(HostedVmInfraInfo.class, 29006);
    kryo.register(K8InfraInfo.class, 29007);
    kryo.register(VmInfraInfo.class, 29008);
