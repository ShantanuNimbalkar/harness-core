...
public class ProjectSecretApiImpl implements ProjectSecretApi {
  ...
  public Response createProjectScopedSecret(
      SecretRequest body, String org, String project, String account, Boolean privateSecret) {
    if (!Objects.equals(org, body.getSecret().getOrg()) || !Objects.equals(project, body.getSecret().getProject())) {
  ...
  public Response updateProjectScopedSecret(
      SecretRequest body, String org, String project, String secret, String account) {
    return updateSecret(body, org, project, secret, account);
  }
