...
public class AzureArtifactsAuthenticationDTO implements SourceCodeManagerAuthentication {
  ...
  @Valid
  @NotNull
  AzureArtifactsCredentialsDTO credentials;

  @Builder
  public AzureArtifactsAuthenticationDTO(GitAuthType authType, AzureArtifactsCredentialsDTO credentials) {
