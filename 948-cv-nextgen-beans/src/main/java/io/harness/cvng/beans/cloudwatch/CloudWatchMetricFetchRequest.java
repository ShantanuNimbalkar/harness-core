...
@JsonTypeName("CLOUDWATCH_METRIC_DATA_REQUEST")
@Data
@SuperBuilder
@NoArgsConstructor
@OwnedBy(CV)
public class CloudWatchMetricFetchRequest extends DataCollectionRequest<AwsConnectorDTO> {
  public static final String DSL =
      CloudWatchMetricFetchRequest.readDSL("cloudwatch-metrics.datacollection", CloudWatchMetricFetchRequest.class);
