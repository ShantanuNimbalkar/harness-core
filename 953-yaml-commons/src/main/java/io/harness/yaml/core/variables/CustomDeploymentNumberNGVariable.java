...
@TypeAlias("io.harness.yaml.core.variables.CustomDeploymentNumberNGVariable")
@RecasterAlias("io.harness.yaml.core.variables.CustomDeploymentNumberNGVariable")
@OwnedBy(CDP)
